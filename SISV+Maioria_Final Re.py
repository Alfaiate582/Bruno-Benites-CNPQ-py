...
de = 0.95  # densidade de suscetíveis

n = 10  # numero de individuos
...
for z in range(2):
    ...
    for lo in range(0, 21):
        ...
        for j in range(testes):
            ...
            # print("PróVacina: ", pro[0])
            # print("Antivacina: ", anti[0])
            # print('-----------------------------------------')
        ...
        if z == 0:
            Iinf[lo] = Re = (1-g*doi) * (de*(l/a))
        elif z == 1:
            Iinf2[lo] = Re = (1-g*doi) * (de*(l/a))
            
        for t in range(tempo + 1):
            Tn[t] = t

        print("Ghama", g, "finished")
...
plt.plot(linf, Iinf, color='sienna', linestyle='dashed', linewidth=1, marker='.', markerfacecolor='black', markersize=3,
         label='D = 0,6')
plt.plot(linf, Iinf2, color='forestgreen', linestyle='dashed', linewidth=1, marker='.', markerfacecolor='black', markersize=3,
         label='D = 0,4')
