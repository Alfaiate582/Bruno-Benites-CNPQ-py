...
plt.plot(linf, Iinf, color='darkorange', linestyle='dashed', linewidth=1, marker='.', markerfacecolor='black', markersize=3,
         label='D = 0,55')
plt.plot(linf, Iinf2, color='indigo', linestyle='dashed', linewidth=1, marker='.', markerfacecolor='black', markersize=3,
         label='D = 0,45')
